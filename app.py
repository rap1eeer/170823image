...
os.environ["REPLICATE_API_TOKEN"] = "r8_0ldbnWWzD7OfWmKgr2c5kCPsV7tytJf4KOneO"
app = Flask(__name__)
...
def index():
    if request.method == "POST":
        ...
        headers = {'Authorization': 'Token r8_0ldbnWWzD7OfWmKgr2c5kCPsV7tytJf4KOneO','Content-Type': 'application/json'}
